...
import { NBadge, NButton, NCard, NFormItem, NInput, NModal, NSelect, useMessage } from 'naive-ui'
...
const { categories, addTemplate, incrementUsage } = useCodeTemplates()
  ...
  <div class="artifact-editor">
    <div class="editor-header">
      ...
      <div class="editor-actions">
        <NButton size="small" type="tertiary" @click="showTemplates">
          <template #icon>
            <Icon icon="ri:archive-line" />
          </template>
          Templates
        </NButton>
        <NButton size="small" type="tertiary" @click="showHistory">
          <template #icon>
            <Icon icon="ri:history-line" />
          </template>
          History
        </NButton>
        <NButton size="small" type="tertiary" @click="formatCode">
          <template #icon>
            <Icon icon="ri:code-line" />
          </template>
          Format
        </NButton>
        <NButton size="small" type="tertiary" @click="saveAsTemplate">
          <template #icon>
      ...
      <div class="editor-main">
        <div class="editor-toolbar">
          <div class="toolbar-left">
            <NButton size="tiny" :disabled="!canUndo" @click="undo">
              <template #icon>
                <Icon icon="ri:arrow-left-line" />
              </template>
              Undo
            </NButton>
            <NButton size="tiny" :disabled="!canRedo" @click="redo">
              <template #icon>
        ...
        <div class="editor-textarea-container">
          ...
          />
          <div ref="lineNumbers" class="line-numbers" @scroll="syncEditor">
        ...
        <div class="editor-footer">
          ...
          <div class="footer-actions">
            <NButton size="tiny" type="error" ghost @click="clearCode">
              <template #icon>
                <Icon icon="ri:delete-bin-line" />
              </template>
              Clear
            </NButton>
            <NButton size="tiny" type="primary" ghost @click="copyCode">
              <template #icon>
            ...
            <div class="template-categories">
              <div v-for="category in filteredCategories" :key="category.id" class="category">
                ...
                <div v-if="expandedCategories.has(category.id)" class="category-templates">
                  <div
                    v-for="template in category.templates" :key="template.id"
                    class="template-item"
        ...
        <div v-if="showHistoryPanel" class="panel history-panel">
          ...
          <div class="panel-content">
            ...
            <div class="history-list">
              <div
                v-for="entry in filteredHistory" :key="entry.id"
                class="history-item"
      ...
      <NCard style="width: 600px" title="Save as Template">
        ...
        <template #footer>
          <div class="modal-actions">
            <NButton @click="showSaveTemplateModal = false">
              Cancel
            </NButton>
