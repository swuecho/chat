...
import ArtifactViewer from '@/views/chat/components/Message/ArtifactViewerBase.vue'
...
<template>
  ...
  <NModal v-model:show="showCommentModal" :mask-closable="false">
    <div class="p-5 bg-white dark:bg-[#1a1a1a] rounded-lg w-[90vw] max-w-[500px]">
      <NInput
        v-model:value="commentContent" type="textarea" :placeholder="$t('chat.commentPlaceholder')"
      ...
      <div class="flex justify-end gap-2 mt-4">
        ...
        <button
          class="px-4 py-2 text-sm text-black bg-[#b0e7af] rounded hover:bg-[#8fd58e]"
